...
public function proba(){
	...
	$query = "SELECT value FROM MySecurity WHERE name='private';";
        ...
        $pub_key=$row[0];
        $pub = openssl_pkey_get_private($pub_key);
     
        openssl_private_encrypt($data,$fileidenc,$pub);
	

	return base64_encode($fileidenc);
}
    ...
    public function giveMeSomeData($param) {
        ...
        */
		...
		//$fileidenc;
		//openssl_private_encrypt($this->someData[$param],&$fileidenc,$pub);
		//$this->someData[$param]=$fileidenc;
